<template>
  <div>
    <v-app-bar height="90" app>
      ...
      <span
        class="font-weight-regular text-uppercase text-h6 mx-4 hidden-sm-and-down"
      >
        Фонд Провидение
      </span>
      <v-spacer></v-spacer>
        ...
        <div class="nav-links hidden-sm-and-down">
          <div class="d-flex justify-center flex-wrap align-with-title">
            ...
            <router-link
              ...
              to="/admin"
            >
              <v-btn small text color="pink">Админ панель</v-btn>
            </router-link>
          </div>
        </div>
      </v-container>
      ...
      <v-dialog class="dialog">
        ...
        <v-card width="100%" height="100%">
          <v-container>
            ...
            <v-row class="mt-n6">
              <v-card-subtitle
                >И мы позвоним Вам в ближайшее время</v-card-subtitle
              >
            </v-row>
          </v-container>
          <v-card-text>
